...
const Navigation: FC = () => {
  return (
    <nav className="flex items-center justify-between w-full h-20 px-4 bg-gray-100 lg:bg-gray-200 dark:bg-gray-800 lg:dark:bg-gray-900 lg:py-4 lg:h-screen lg:w-20 lg:flex-col">
